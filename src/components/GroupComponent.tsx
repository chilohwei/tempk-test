...
const GroupComponent: FunctionComponent<GroupComponentType> = ({
  ...
  return (
    <div
      className={`w-[25rem] shadow-[0px_40px_80px_12px_rgba(30,_48,_118,_0.25)] rounded-3xl [background:linear-gradient(180deg,_#fff,_#e3e9ff)] flex flex-col items-start justify-start pt-[2rem] pb-[2.5rem] pl-[2rem] pr-[1.25rem] box-border gap-[0.75rem] max-w-full z-[2] text-left text-[1.5rem] text-mediumslateblue-100 font-roboto ${className}`}
    >
